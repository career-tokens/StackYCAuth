    ...
    <div className="w-full h-[60%] px-3 flex flex-col justify-evenly items-center z-[1000]">
      <div className="gap-y-3 text-center">
        ...
        <p className="pt-3  text-[#3aaf9f] dark:text-[#5dd59c]">
          ...
          {user?.primaryEmail} to verify your account
        </p>
      </div>
      <p className="pt-3  text-[#3aaf9f] dark:text-[#5dd59c]">
        ...
        <button
          onClick={onSubmit}
          className="ml-2 px-3 py-1 rounded bg-black bg-opacity-10 text-black dark:text-white dark:bg-white dark:bg-opacity-20"
        >
          Send Again
        </button>
      </p>
