  ...
  return (
      ...
      >
        <div className="text-2xl sm:text-3xl font-bold text-center text-[#3aaf9f] dark:text-[#5dd59c]">
          ...
          {!user?.primaryEmailVerified&&<p className="pt-3  text-[#3aaf9f] dark:text-[#5dd59c]">
            You need to verify your email to view the code. 
            <Link href="/verify-email">
                  <span className="ml-2 px-3 py-2 rounded bg-white bg-opacity-10">Verify here</span>
              </Link>
        </p>}
        <Link
          href=""
          id="code"
        >
            <button disabled={!user?.primaryEmailVerified}
